 ...
 */
class i18n_Locale_sr_Cyrl_BA_Data extends i18n_Locale
{
    ...
    public function intervals(): array
    {
        return [
            ...
            'week'        => '{n, plural, one {# недјеља} few {# недјеље} other {# недјеља}}',
