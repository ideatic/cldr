 ...
 */
class i18n_Locale_be_TARASK_Data extends i18n_Locale
{
    public function __construct()
    {
        ...
        $this->amString = 'апоўначы';
        $this->pmString = 'апоўдні';
        $this->nameEnglish = 'Belarusian';
        $this->nameNative = 'Беларуская (клясычная)';
    }
    ...
    public function intervals(): array
    {
        return [
            ...
            'second'      => '{n, plural, one {# сэк.} few {# сэк.} many {# сэк.} other {# сэк.}}',
            'microsecond' => '{n, plural, one {# мкс.} few {# мкс.} many {# мкс.} other {# мкс.}}',
            'nanosecond'  => '{n, plural, one {# нсэк.} few {# нсэк.} many {# нсэк.} other {# нсэк.}}',
