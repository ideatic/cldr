 ...
 */
class i18n_Locale_ar_AE_Data extends i18n_Locale
{
    public function __construct()
    {
        ...
        $this->amString = 'ص';
        $this->pmString = 'م';
        $this->nameEnglish = 'Arabic (United Arab Emirates)';
        $this->nameNative = 'العربية (الإمارات العربية المتحدة)';
    }
