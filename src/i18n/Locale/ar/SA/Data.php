 ...
 */
class i18n_Locale_ar_SA_Data extends i18n_Locale
{
    public function __construct()
    {
        ...
        $this->amString = 'ص';
        $this->pmString = 'م';
        $this->nameEnglish = 'Arabic (Saudi Arabia)';
        $this->nameNative = 'العربية (المملكة العربية السعودية)';
    }
