 ...
 */
class i18n_Locale_pt_ST_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Portuguese (São Tomé & Príncipe)';
        $this->nameNative = 'Português (São Tomé e Príncipe)';
    }
