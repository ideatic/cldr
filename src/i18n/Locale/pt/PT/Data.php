 ...
 */
class i18n_Locale_pt_PT_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'da manhã';
        $this->pmString = 'da tarde';
        $this->nameEnglish = 'European Portuguese';
        $this->nameNative = 'Português europeu';
    }
