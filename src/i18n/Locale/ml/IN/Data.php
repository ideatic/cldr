 ...
 */
class i18n_Locale_ml_IN_Data extends i18n_Locale
{
    public function __construct()
    {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Malayalam (India)';
        $this->nameNative = 'മലയാളം (ഇന്ത്യ)';
    }
    ...
    {
        return [
            'year'        => '{n, plural, one {# വർഷം} one {# വർഷത്തെ} one {# വർഷത്തിന്} one {# വർഷത്തിന്റെ} other {# വർഷം} other {# വർഷം} other {# വർഷം} other {# വർഷം}}',
