 ...
 */
class i18n_Locale_fr_CA_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->longTime = 'H g i \\m\\i\\n s s';
        $this->shortTime = 'H g i';
        $this->dateTime = '%date%, %time%';
        $this->amString = 'a.m.';
        $this->pmString = 'p.m.';
        $this->nameEnglish = 'Canadian French';
        $this->nameNative = 'Français canadien';
    }
