 ...
 */
class i18n_Locale_fr_CG_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'French (Congo (Republic))';
        $this->nameNative = 'Français (République du Congo)';
    }
