 ...
 */
class i18n_Locale_fr_CI_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'French (Ivory Coast)';
        $this->nameNative = 'Français (​​République de Côte d’Ivoire)';
    }
