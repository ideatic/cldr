 ...
 */
class i18n_Locale_ms_ID_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'PG';
        $this->pmString = 'PTG';
        $this->nameEnglish = 'Malay (Indonesia)';
        $this->nameNative = 'Melayu (Indonesia)';
    }
