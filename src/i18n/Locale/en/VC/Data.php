 ...
 */
class i18n_Locale_en_VC_Data extends i18n_Locale
{
    public function __construct()
    {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'English (St. Vincent & Grenadines)';
        $this->nameNative = 'English (St. Vincent & Grenadines)';
    }
