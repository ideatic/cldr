 ...
 */
class i18n_Locale_pt_TL_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Portuguese (East Timor)';
        $this->nameNative = 'Português (República Democrática de Timor-Leste)';
    }
