 ...
 */
class i18n_Locale_pt_GQ_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Portuguese (Equatorial Guinea)';
        $this->nameNative = 'Português (Guiné Equatorial)';
    }
