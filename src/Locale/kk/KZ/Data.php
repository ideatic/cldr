 ...
 */
class i18n_Locale_kk_KZ_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Kazakh (Kazakhstan)';
        $this->nameNative = 'Қазақ тілі (Қазақстан)';
    }
    ...
    public function months($type = i18n_Locale::TYPE_WIDE): array{
        ...
        public function intervals(): array{
              ...
              'day' => '{n, plural, one {# тәулік} other {# тәулік}}',
