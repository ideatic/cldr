 ...
 */
class i18n_Locale_es_HN_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'a. m.';
        $this->pmString = 'p. m.';
        $this->nameEnglish = 'Spanish (Honduras)';
        $this->nameNative = 'Español (Honduras)';
    }
