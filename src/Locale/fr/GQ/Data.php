 ...
 */
class i18n_Locale_fr_GQ_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'French (Equatorial Guinea)';
        $this->nameNative = 'Français (Guinée équatoriale)';
    }
