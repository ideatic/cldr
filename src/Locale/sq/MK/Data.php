 ...
 */
class i18n_Locale_sq_MK_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->nameEnglish = 'Albanian (North Macedonia)';
        $this->nameNative = 'Shqip (Maqedonia e Veriut)';
    }
