 ...
 */
class i18n_Locale_am_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'ጥዋት';
        $this->pmString = 'ከሰዓት';
        $this->nameEnglish = 'Amharic';
        $this->nameNative = 'አማርኛ';
    }
    ...
    public function months($type = i18n_Locale::TYPE_WIDE): array{
        ...
        public function intervals(): array{
                    return array (
              'year' => '{n, plural, one {# ዓመት} other {# ዓመታት}}',
              'month' => '{n, plural, one {# ወር} other {# ወራት}}',
              'week' => '{n, plural, one {# ሳምንት} other {# ሳምንታት}}',
              'day' => '{n, plural, one {# ቀናት} other {# ቀናት}}',
