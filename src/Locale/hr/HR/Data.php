 ...
 */
class i18n_Locale_hr_HR_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'Croatian (Croatia)';
        $this->nameNative = 'Hrvatski (Hrvatska)';
    }
    ...
    public function months($type = i18n_Locale::TYPE_WIDE): array{
        ...
        public function intervals(): array{
              ...
              'week' => '{n, plural, one {# tjedan} few {# tjedna} other {# tjedana}}',
