 ...
 */
class i18n_Locale_zh_Hans_SG_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = '上午';
        $this->pmString = '下午';
        $this->nameEnglish = 'Simplified Mandarin Chinese';
        $this->nameNative = '现代标准汉语';
    }
