 ...
 */
class i18n_Locale_en_FK_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'English (Falkland Islands (Islas Malvinas))';
        $this->nameNative = 'English (Falkland Islands (Islas Malvinas))';
    }
