 ...
 */
class i18n_Locale_en_CC_Data extends i18n_Locale
{
    public function __construct() {
        ...
        $this->amString = 'AM';
        $this->pmString = 'PM';
        $this->nameEnglish = 'English (Cocos (Keeling) Islands)';
        $this->nameNative = 'English (Cocos (Keeling) Islands)';
    }
